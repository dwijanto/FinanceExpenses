Public Class FormSAPIndex
    ...
    Private Shared myform As FormSAPIndex
    Dim myController As SAPIndexController

    Public Shared Function getInstance()
        If myform Is Nothing Then
            myform = New FormSAPIndex
    ...
    Sub DoWork()
        myController = New SAPIndexController
        Try
