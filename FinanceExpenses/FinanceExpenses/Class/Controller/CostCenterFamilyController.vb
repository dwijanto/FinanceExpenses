Public Class CostCenterFamilyController
    Implements IController
    Implements IToolbarAction

    Public Model As New CostCenterFamilyModel
    ...
    Public Function loaddata() As Boolean Implements IController.loaddata
        ...
        Model = New CostCenterFamilyModel
        DS = New DataSet
        If Model.LoadData(DS, "") Then
            Dim pk(0) As DataColumn
            pk(0) = DS.Tables(0).Columns("costcenterfamily")
