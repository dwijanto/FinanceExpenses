...
Public Class SAPIndexModel
    Implements IModel

    Public ReadOnly Property FilterField
        Get
            Return "sapce like '%{0}%' or costcenterfamily like '%{0}%'"
        End Get
    End Property
    ...
    Public Function save(ByVal obj As Object, ByVal mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As IDbConnection = factory.CreateConnection
            ...
            sqlstr = "ssc.sp_insertsapindex"
            dataadapter.InsertCommand = factory.CreateCommand(sqlstr, conn)
            dataadapter.InsertCommand.Parameters.Add(factory.CreateParameter("", DbType.String, 0, "sapce", DataRowVersion.Current))
            ...
            dataadapter.UpdateCommand.Parameters.Add(factory.CreateParameter("", DbType.String, 0, "sapce", DataRowVersion.Current))
